...
const GROUPS: Group[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { press: "Tab", does: "draft answers with the agent" },
      { commands: ["generate"], does: "draft answers with the agent" },
      { press: "⌘J", does: "open or close the debate agent" },
      { press: "⇧⌘J", does: "expand the agent over the flow" },
      { press: "Tab", does: "accept the agent answer under the cursor" },
      { press: "Esc", does: "dismiss the agent answer under the cursor" },
      ...
      { press: "Tab", does: "finish the word while editing" },
  ...
  },
  {
    ...
    rows: [
      ...
      { commands: ["important"], does: "shade it as important" },
  ...
  },
  {
    ...
    rows: [
      ...
      { press: ":import", does: "turn a 1AC or 1NC file into flows" },
      { press: ":export", does: "write selected positions as a .cmir speech" },
      { press: ":read", does: "read one evidence file into agent context" },
